          ...
          child: Column(
            ...
            children: [
                ...
                child: LineChart(
                  LineChartData(
                    ...
                    lineBarsData: [
                      ...
                      // 2. Actual spending trajectory
                      LineChartBarData(
                        spots: actualSpots,
                        isCurved: true,
                        color: runningActualPct > 100.0 ? const Color(0xFFE53935) : (isDark ? const Color(0xFF00E676) : const Color(0xFF2ECC71)),
                        barWidth: 3,
                        isStrokeCapRound: true,
                        dotData: const FlDotData(show: false),
                        belowBarData: BarAreaData(
                          show: true,
                          color: (runningActualPct > 100.0 ? const Color(0xFFE53935) : (isDark ? const Color(0xFF00E676) : const Color(0xFF2ECC71))).withValues(alpha: 0.08),
                        ),
                      ),
                      // 3. Projected pace trajectory
                      LineChartBarData(
                        spots: projectedSpots,
                        isCurved: false,
                        color: (isDark ? const Color(0xFFFFD700) : const Color(0xFFD4AF37)).withValues(alpha: 0.4),
                        barWidth: 2,
                        dashArray: [5, 5],
                        dotData: const FlDotData(show: false),
                      ),
              ...
              Row(
                ...
                children: [
                  _buildChartLegendItem('Projected Pace', isDark ? const Color(0xFFFFD700) : const Color(0xFFD4AF37), isDashed: true),
                  const SizedBox(width: 16),
                  _buildChartLegendItem('Actual Spend', runningActualPct > 100.0 ? const Color(0xFFE53935) : (isDark ? const Color(0xFF00E676) : const Color(0xFF2ECC71))),
                ],
              ),
            ],
          ),
